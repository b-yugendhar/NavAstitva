...
export const CscAssistedOnboardingPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-12">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-3xl p-6 sm:p-8 shadow-md relative overflow-hidden">
        <div className="relative z-10 max-w-2xl space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 border border-white/30 text-white text-xs font-bold">
            ...
            <span>Assisted Access Desk</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight">
            CSC Assisted Onboarding
          </h1>
          <p className="text-xs sm:text-sm text-white/90 leading-relaxed">
            Register skilled workers with basic phones. Generates verifiable QR identification cards and enables SMS/voice job alerts.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center gap-3">
                ...
                <label htmlFor="aadhaar-chk" className="text-xs text-slate-700 font-semibold cursor-pointer">
                  Physical Identity Proof & details verified in-person.
                </label>
              </div>
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 disabled:opacity-50 text-white rounded-xl text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-2 cursor-pointer"
              >
                {isSubmitting ? (
                  <>
                  ...
                  <>
                    ...
                    <span>Complete Registration & Generate QR Card</span>
                  </>
                )}
              </button>
            </form>
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          {registeredCard ? (
            <div className="bg-white border-2 border-orange-500 rounded-2xl p-6 shadow-md space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-orange-500 to-red-500 flex items-center justify-center text-white font-black text-sm">
                    NA
                  </div>
                  <div>
                    <div className="font-extrabold text-xs text-slate-900">Verified ID Card</div>
                    <div className="text-[10px] text-slate-400">Skill Credential Card</div>
                  </div>
                </div>

                <span className="text-[10px] font-mono font-bold bg-orange-100 px-2 py-0.5 rounded text-orange-700">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-xs font-bold text-orange-700">{registeredCard.primarySkill}</div>
              ...
              <div className="p-3 bg-orange-50 rounded-xl border border-orange-200 text-xs text-orange-950 space-y-1">
                <div className="font-bold flex items-center gap-1">
                  <CheckCircle2 className="w-3.5 h-3.5 text-orange-600" />
                  <span>Assisted Verification Completed</span>
                </div>
                <div className="text-[11px] text-orange-800">
                  Scan QR code to view verified skill certifications and past ratings without requiring a mobile app.
                </div>
              </div>
            ...
            <div className="p-8 text-center text-slate-400 bg-white rounded-2xl border border-dashed border-slate-300 space-y-2">
              ...
              <p className="text-[11px] text-slate-400 max-w-xs mx-auto">
                Fill out the assisted registration form. The printable QR Identity Card will generate here.
              </p>
            </div>
          )}
        </div>
